...
class fsdp_config:
    ...
    use_fp16: bool=False
    sharding_strategy: ShardingStrategy = ShardingStrategy.SHARD_GRAD_OP # HYBRID_SHARD "Full Shard within a node DDP cross Nodes", SHARD_GRAD_OP "Shard only Gradients and Optimizer States", NO_SHARD "Similar to DDP".
