...
def smooth_quant(model, weight_quant="per_channel", act_quant="per_token"):
    for name, module in model.named_modules():
        if isinstance(module, FeedForward):
            module.w1 = W8A8Linear.from_float(
                module.w1, weight_quant=weight_quant, act_quant=act_quant
            )
            module.w2 = W8A8Linear.from_float(
                module.w2, weight_quant=weight_quant, act_quant=act_quant
            )
            module.w3 = W8A8Linear.from_float(
                module.w3, weight_quant=weight_quant, act_quant=act_quant
            )
